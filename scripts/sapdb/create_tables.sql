sql_execute create table warehouse ( w_id fixed(9), w_name varchar(10), w_street_1 varchar(20), w_street_2 varchar(20), w_city varchar(20), w_state char(2), w_zip char(9), w_tax fixed(8, 4), w_ytd fixed(24, 12) )
...
sql_execute create table new_order ( no_o_id fixed(8), no_d_id fixed(2), no_w_id fixed(9) )
